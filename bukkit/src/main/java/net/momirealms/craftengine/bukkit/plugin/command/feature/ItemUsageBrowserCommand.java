...
public class ItemUsageBrowserCommand extends BukkitCommandFeature<CommandSender> {

    public ItemUsageBrowserCommand(CraftEngineCommandManager<CommandSender> commandManager, CraftEngine plugin) {
