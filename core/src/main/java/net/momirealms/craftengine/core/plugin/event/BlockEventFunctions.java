...
public class BlockEventFunctions {
    ...
    public static void register(Key key, FunctionFactory<PlayerBlockActionContext> factory) {
        Holder.Reference<FunctionFactory<PlayerBlockActionContext>> holder = ((WritableRegistry<FunctionFactory<PlayerBlockActionContext>>) BuiltInRegistries.PLAYER_BLOCK_FUNCTION_FACTORY)
    ...
    public static Function<PlayerBlockActionContext> fromMap(Map<String, Object> map) {
        ...
        FunctionFactory<PlayerBlockActionContext> factory = BuiltInRegistries.PLAYER_BLOCK_FUNCTION_FACTORY.getValue(key);
        if (factory == null) {
