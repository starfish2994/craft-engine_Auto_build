...
public class MessageFunction<CTX extends Context> extends AbstractConditionalFunction<CTX> {
    ...
    public MessageFunction(List<Condition<CTX>> predicates, List<TextProvider> messages, @Nullable PlayerSelector<CTX> selector, boolean overlay) {
        super(predicates);
    ...
    public static class FactoryImpl<CTX extends Context> extends AbstractFactory<CTX> {
        ...
        public Function<CTX> create(Map<String, Object> arguments) {
            ...
            return new MessageFunction<>(getPredicates(arguments), messages, PlayerSelectors.fromObject(arguments.get("target"), conditionFactory()), overlay);
        }
    }
}
